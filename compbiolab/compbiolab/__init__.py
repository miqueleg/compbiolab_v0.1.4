...
def plot_dist(data, legend=True, names='default' , color='default', window_size=50, style='default',
              font_scale=2, figure_size=(20,10), title=False, x_label='nanoseconds', y_label=False, x_limits='default',
              y_limits='default', vertical_lines=False, horizontal_lines=False,  line_width=1, x_label_fontsize=18,
              y_label_fontsize=18, read_every=1):
    '''
